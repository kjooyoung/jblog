		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
					...
					<li><a href="${pageContext.request.contextPath}/admin/category/${authUser.no}">카테고리</a></li>
					<li><a href="${pageContext.request.contextPath}/admin/write/${authUser.no}">글작성</a></li>
				</ul>
